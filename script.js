...
var endDate = new Date("Oct 23, 2024 00:00:00").getTime();
...
function playsound() {
    var mysound = document.getElementById("song");
...
class Birthday {
  ...
  update(delta) {
    var isChecked = document.getElementById("click").checked
    var displayedClickInfo = document.getElementById("click-info").style.display

    if(isChecked && displayedClickInfo == "block"){
